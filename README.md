...
#### An Epicodus project in Javascript using Gulp, Bower, Css, Angular2, Node.js, TypeScript and HTML 07.07.17
...
This web application will allow a user to see a list of current Animals residing in the Zoo. It also allows a user to edit properties of a specific animal and add a new animal to the list of animals in Zoo. The user can filter by certain age criteria via the first drop-down.
